...
export class initial1644142663279 implements MigrationInterface {
    name = 'initial1644142663279'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "snapshot" ("id" varchar PRIMARY KEY NOT NULL, "branch" varchar NOT NULL, "ref" varchar NOT NULL, "date" varchar NOT NULL, "projectId" varchar NOT NULL)`);
